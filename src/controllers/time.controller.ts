...
export const createManualEntryController = async (req: Request, res: Response) => {
    try {
...
export const regularizeEntryController = async (req: Request, res: Response) => {
    try {
...
export const reviewRegularizationController = async (req: Request, res: Response) => {
    try {
        const { entryId } = regularizeParamsSchema.parse(req.params);
